...
const DEST_DIR = path.join('D:/nuxt-test/fork/edu-app/public/sounds/vietnamese/rhymes') // Đổi đường dẫn theo nhu cầu
...
async function run() {
    while (true) {
        ...
        // Cập nhật texts.json sau khi tải xong batch
